...
class UploadWhats extends StatefulWidget {
  @override
  _UploadWhatsState createState() => _UploadWhatsState();
}

class _UploadWhatsState extends State<UploadWhats> {
  ...
  post(BuildContext context) {
    ...
    if (formKey.currentState.validate()) {
      ...
      databaseMethods.uploadWhats(postMap);
  ...
  uploadPic(BuildContext context) async {
    ...
    FirebaseStorage.instance.ref().child('whatshappening/$filenamenew+$date');
    UploadTask uploadTask = firebaseStorageRef.putFile(_image);
    //var storage = FirebaseStorage.instance.ref();
    TaskSnapshot taskSnapshot =
    await uploadTask.whenComplete(() {
      setState(() async {
        print("Whats pic uploaded");
        //storage.child('gs://campconnectchat.appspot.com/users/$useremail').getDownloadURL().then((value) {
        final ref = FirebaseStorage.instance.ref('whatshappening/$filenamenew+$date');
                    ...
                    child: Form(
                      ...
                      child: Column(mainAxisSize: MainAxisSize.min, children: [
                        ...
                        TextFormField(
                          validator: (val) {
                            return val.isEmpty
                                ? "Please provide a valid What's happening Title"
                                : null;
                          },
                        ...
                        Container(
                          child: TextFormField(
                            validator: (val) {
                              return val.isEmpty
                                  ? "Please provide a valid What's happening Body"
                                  : null;
                            },
                            maxLines: 12,
