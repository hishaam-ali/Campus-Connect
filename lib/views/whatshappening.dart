...
class _whatsState extends State<whats> {
 ...
 bool noContent = false;
  ...
  getWhats() {
    databaseMethods.getWhatsHappening().then((value) {
      setState(() {
        if(value!= null)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      ) : noContent ? Container(child: Center(child: Text('No news at the moment',style: TextStyle(fontFamily: 'Nunito'),)),) :whatsTile(searchSnapshot),
    );
  }
}


class whatsTile extends StatefulWidget {
  final QuerySnapshot snap;
  whatsTile(this.snap);

  @override
  _whatsTileState createState() => _whatsTileState();
}

class _whatsTileState extends State<whatsTile> {
