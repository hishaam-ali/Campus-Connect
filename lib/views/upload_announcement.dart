...
class UploadAnnouncements extends StatefulWidget {
  @override
  _UploadAnnouncementsState createState() => _UploadAnnouncementsState();
}
...
class _UploadAnnouncementsState extends State<UploadAnnouncements> {
  ...
  post(BuildContext context) {
    ...
    if (formKey.currentState.validate()) {
      ...
      databaseMethods.uploadAnnouncement(postMap);
  ...
  uploadPic(BuildContext context) async {
    ...
    FirebaseStorage.instance.ref().child('announcements/$filenamenew+$date');
    UploadTask uploadTask = firebaseStorageRef.putFile(_image);
    //var storage = FirebaseStorage.instance.ref();
    TaskSnapshot taskSnapshot =
    await uploadTask.whenComplete(() {
      setState(() async {
        print("Announcement pic uploaded");
        //storage.child('gs://campconnectchat.appspot.com/users/$useremail').getDownloadURL().then((value) {
        final ref = FirebaseStorage.instance.ref('announcements/$filenamenew+$date');
                    ...
                    child: Form(
                      ...
                      child: Column(mainAxisSize: MainAxisSize.min, children: [
                        ...
                        TextFormField(
                          validator: (val) {
                            return val.isEmpty
                                ? 'Please provide a valid Announcement Title'
                                : null;
                          },
                        ...
                        Container(
                          child: TextFormField(
                            validator: (val) {
                              return val.isEmpty
                                  ? 'Please provide a valid Announcement body'
                                  : null;
                            },
                            maxLines: 12,
